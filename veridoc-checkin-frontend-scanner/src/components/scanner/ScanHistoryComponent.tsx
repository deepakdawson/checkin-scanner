...
import { BsFiletypeSvg, BsChevronLeft, BsChevronRight } from "react-icons/bs";
import { CiLocationOn } from "react-icons/ci";
import {
    FiGrid,
    FiUsers
            ...
            <div className="mt-auto pt-8">
                <div className="flex items-center justify-center gap-4">
                     <button
                        ...
                        className={`flex items-center justify-center w-10 h-10 ${currentPage === 1
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-4 py-2 rounded-lg bg-[#24984e] text-white font-medium">
                            {currentPage}
                        </span>
                    </div>
